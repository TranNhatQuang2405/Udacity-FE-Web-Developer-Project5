...
import { getGeoInfo, getImageInfo, getWeatherInfo } from './js/callApi';

window.addEventListener('DOMContentLoaded', initAllListener);

export { initAllListener, validateInputDate, validateInputLocation, getGeoInfo, getImageInfo, getWeatherInfo }
